...
/**************************************************
  ...
  ********************************************
  $HeadURL: https://coppermine.svn.sourceforge.net/svnroot/coppermine/branches/cpg1.5.x/plugins/enlargeit/lang/english.php $
  $Revision: 6989 $
...
$lang_plugin_enlargeit['button_picture'] = 'Display button "Посмотреть изображение"';
$lang_plugin_enlargeit['show_picture'] = 'Посмотреть изображение'; // js-alert
$lang_plugin_enlargeit['button_info'] = 'Show button "Информация"';
...
$lang_plugin_enlargeit['show_info'] = 'Показать информацию'; // js-alert
$lang_plugin_enlargeit['button_download'] = 'Display "Download" button ';
$lang_plugin_enlargeit['download_this_file'] = 'Скачать выбранный файл'; // js-alert
...
$lang_plugin_enlargeit['favorites'] = 'Нравиться'; // js-alert
$lang_plugin_enlargeit['button_comments'] = 'Display "Комментарии" button';
$lang_plugin_enlargeit['comment'] = 'Комментарий';
...
$lang_plugin_enlargeit['button_vote'] = 'Display "Голосование" button';
$lang_plugin_enlargeit['vote'] = 'Голосование';
$lang_plugin_enlargeit['full_size'] = 'Полный размер'; // js-alert
...
$lang_plugin_enlargeit['close_esc'] = 'Закрыть [Esc]'; // js-alert
$lang_plugin_enlargeit['button_navigation'] = 'Display "Управление" buttons';
$lang_plugin_enlargeit['previous_left'] = 'Предидущий файл [клавиша левой стрелки]'; // js-alert
$lang_plugin_enlargeit['next_right'] = 'Следующий файл [клавиша правой стрелки]'; // js-alert
...
$lang_plugin_enlargeit['cancel_loading'] = 'Нажмите на кнопку, чтобы отменить загрузку фотографии'; // js-alert
$lang_plugin_enlargeit['no_flash_found'] = 'Для просмотра этого файла, вам необходимо установить проигрыватель Adobe Flash Player'; // js-alert
