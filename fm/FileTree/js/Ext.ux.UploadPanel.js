...
Ext.ux.UploadPanel = Ext.extend(Ext.Panel, {
	 ...
	 */
	,clickRemoveText: Res.get('ClickToRemove')

	/**
	 * @cfg {String} clickStopText
	 */
	,clickStopText: Res.get('ClickToStop')

	/**
	 * @cfg {String} emptyText empty text for dataview
	 */
	,emptyText: Res.get('NoFiles')
	 ...
	 */
	,fileQueuedText: Res.get('FileIsQueuedForUploadMask')

	/**
	 * @cfg {String} fileDoneText File upload status text
	 */
	,fileDoneText: Res.get('FileHasBeenSuccessfullyUploadedMask')

	/**
	 * @cfg {String} fileFailedText File upload status text
	 */
	,fileFailedText: Res.get('FileFailedToUploadMask')

	/**
	 * @cfg {String} fileStoppedText File upload status text
	 */
	,fileStoppedText: Res.get('FileStoppedByUserMask')

	/**
	 * @cfg {String} fileUploadingText File upload status text
	 */
	,fileUploadingText: Res.get('UploadingFileMask')
	 ...
	 */
	,removeAllText: Res.get('RemoveAll')
...
//					+ '<div class="ux-up-indicator">&#160;</div>'
	...
	,getQtip:function(values) {
		...
		switch(values.state) {
			...
			case 'failed':
				...
				qtip += '<br>' + this.errorText + ':' + Ext.util.Format.htmlEncode(values.error);
				qtip += '<br>' + this.clickRemoveText;
			break;
	...
	,updateButtons:function() {
		if(true === this.uploading) {
			...
			this.addBtn.setDisabled(!this.enableAdd);
			this.uploadBtn.enable();
