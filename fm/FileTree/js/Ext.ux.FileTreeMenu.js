...
Ext.ux.FileTreeMenu = function(config) {
    ...
    ,new Ext.menu.Separator({cmd:'sep-properties'})
    ,{
       text:this.editPropertiesText
      ,iconCls:this.editPropertiesIconCls
      ,cmd:'editproperties'
    }
...
Ext.extend(Ext.ux.FileTreeMenu, Ext.menu.Menu, {
	 ...
	 */
	  ...
	  */
	, collapseText: Res.get('CollapseAll')
	 ...
	 */
	,deleteKeyName: Res.get('DeleteKeyName')
  ...
  ,editPropertiesIconCls:'icon-open-self'
  ...
  ,editPropertiesText: Res.get('EditProperties') + '...'
	 ...
	 */
	,openBlankText:Res.get('OpenBlankText')
	 ...
	 */
	, openDwnldText: Res.get('FileStorageDownload')
	 ...
	 */
	,openPopupText:Res.get('OpenPopupText')
	 ...
	 */
	,openSelfText: Res.get('OpenSelfText')

	/**
	 * @cfg {String} openText text for open submenu
	 */
	, openText: Res.get('Open')
	 ...
	 */
	,renameText: Res.get('FileStorageRename')
	
	/**
	 * @cfg {String} uploadFileText text for upload file item
	 */
	,uploadFileText: Res.get('UploadFileText')
