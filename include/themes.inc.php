...
<!-- BEGIN header -->
        <tr>
                <td class="tableh2" width="80%" align="left">{CATEGORY}</td>
                <td class="tableh2" width="10%" align="center">{ALBUMS}</td>
                <td class="tableh2" width="10%" align="center">{PICTURES}</td>
        </tr>
<!-- END header -->
<!-- BEGIN catrow_noalb -->
        <tr>
...
<!-- END slideshow_button -->
                <td align="center" valign="middle" class="navmenu" style="font-weight:normal" width="100%">{PIC_POS}</td>
...
{
    global $CONFIG;
	//$return = $BREADCRUMB_TEXT[0];//$CONFIG['TABLE_ALBUMS'];
	$return = strip_tags(bb_decode($section));// . ' - ' . $CONFIG['gallery_name'];
    //$return = $BREADCRUMB_TEXT;//strip_tags(bb_decode($section));// . ' - ' . $CONFIG['gallery_name'];
    return $return;
}
/******************************************************************************
